...
ふもとから必死で追いかけてきた長者たちが、ようやく命蓮に追いつき、「どうか蔵を返してください」と泣きながら懇願している場面です。画面左側には、山頂に到着した蔵と、そこからこぼれ出た大量の米俵が描かれています。""",
...
長者が「蔵を返してほしい」と頼んだのに対し、命蓮は「蔵を返すのは難しいが、中身の米は返してあげよう」と答えます。 そして、**「この鉢の上に米俵を一つ載せなさい」**と指示しました。画像中央では、長者の従者が不思議そうに、あるいは恐る恐る鉢の上の米俵に触れています。この一俵が「リーダー」となって、他の数千俵を連れて空を飛ぶことになるのです。""",
            "画面全体の構成で注目すべきポイントは何ですか？": """「静」と「動」の対比、そして人々の心理描写です。
...
この場面は、物語は命蓮の姉である**「尼公（あまぎみ）」**を主人公としたエピソードの一部です。信濃国（現在の長野県）に住んでいた尼公は、20年も音信不通だった弟の命蓮を探すため、はるばる奈良までやってきました。""",
