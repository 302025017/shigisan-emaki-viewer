...
ユーザー: 「第17コマ」に切り替え
  ↓
Flask: app_state.set_scene("scene_17") 実行
  ↓
  current_scene_id = "scene_17"
  chat_history = []  ← リセット！
  ↓
JavaScript: 画面を更新
  ↓
プレースホルダー: 「第17コマについて質問を選択してください」
質問プルダウン: 第17コマの質問リストで更新
  ↓
新しく質問
  question: 「第17コマの質問」
  answer: 「第17コマの答え」
...
【第7コマでの会話】
Q: 「この場面では一体何が起きているのですか？」
A: 「画面の上部に見えるのは蔵の底の部分で...」
